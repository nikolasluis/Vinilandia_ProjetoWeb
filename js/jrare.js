...
function montarBotao(){
	...
	if(produtos[5][4]==false){
		conteudo += "<button class='button_adicionar_sacola' onclick='adicionarCarrinhoRare()'> Adicionar à sacola </button>";
	}
	else{
		conteudo += "<p> Na Sacola de Compras! </p>";
	}
	document.getElementById("teste2").innerHTML += conteudo;
