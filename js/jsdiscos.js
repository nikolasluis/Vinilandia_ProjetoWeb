...
function pag_discos1() {
	document.getElementById("b_discos1").value
	location.href = "http://localhost/vinilandia_projetoweb/pag/kacey-musgraves-golden-hour.html"
}

function pag_discos2() {
	document.getElementById("b_discos2").value
	location.href = "http://localhost/vinilandia_projetoweb/pag/selena-gomez-rare.html"
}

function pag_discos3() {
	document.getElementById("b_discos3").value
	location.href = "http://localhost/vinilandia_projetoweb/pag/lana-del-rey-born-to-die.html"
}
...
function adicionarCarrinhoGolden(){
	criarCarrinho();
	var id = 4;
	adicionarProduto(id);
}

function adicionarCarrinhoRare(){
	criarCarrinho();
	var id = 5;
	adicionarProduto(id);
}
...
function montarBotao(){
	...
	if(produtos[4][4]==false){
		conteudo += "<button class='buttonEtiqueta1' onclick='adicionarCarrinhoGolden()'> COMPRAR </button>";
	}
	else{
	...
	var conteudo2="";
	if(produtos[5][4]==false){
		conteudo2 += "<button class='buttonEtiqueta2' onclick='adicionarCarrinhoRare()'> COMPRAR </button>";
	}
	else{
	...
	if(produtos[6][4]==false){
		conteudo3 += "<button class='buttonEtiqueta3' onclick='adicionarCarrinhoBorn()'> COMPRAR </button>";
	}
	else{
