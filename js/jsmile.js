...
var produtos_aux = [['dont smile at me','Billie Eilish',116.10,'img02.png',false],['Fine Line','Harry Styles',204.60,'img03.png',false],
['WHEN WE ALL FALL ASLEEP, WHERE DO WE GO?','Billie Eilish',115.42,'img04.png',false],['Golden Hour','Kacey Musgraves',121.24,'img05.png',false],
...
function montarBotao(){
	...
	if(produtos[1][4]==false){
		conteudo += "<button class='button_adicionar_sacola' onclick='adicionarCarrinhoSmile()'> Adicionar à sacola </button>";
	}
	else{
